...
class MQTT:
    ...
    def __init__(self,mongo):
        ...
        self.client.message_callback_add("620162297",self.update)
        self.client.message_callback_add("620162297_sub", self.update)
        self.client.message_callback_add("620162297_pub", self.update)
    ...
    def update(self, client, userdata, msg):
        ...
        try:
            ...
            weatherInfo = loads(payload) # CONVERT FROM JSON STRING TO JSON OBJECT
            self.mongo.update(weatherInfo)
            # print(weatherInfo)
        except Exception as e:
